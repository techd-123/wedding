...
class WeddingProfile(models.Model):
    ...
    bride = models.CharField(max_length=100, null=False, blank=False)
    groom = models.CharField(max_length=100, null=False, blank=False)
    religion = models.CharField(max_length=100, choices=RELIGION_CHOICES, null=False, blank=False)
    caste = models.CharField(max_length=100, choices=CASTE_CHOICES, null=False, blank=False)
